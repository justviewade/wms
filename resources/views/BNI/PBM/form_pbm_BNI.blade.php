    ...
    <div class="container" style="max-width:100% !important;">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('listpbmsps2')}}">Penerimaan Barang</a></li>
                <li class="breadcrumb-item active"><a href="{{url('listpbm')}}">Penerimaan Barang Masuk </a></li>
            </ol>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Formulir Permohonan Barang Masuk</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="dynamic" action="{{ url('inputpbm')}}" method="POST" autocomplete="off">
                                @csrf
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input id="datetimepicker" name="tgl_pbm_masuk" type="text" class="form-control" placeholder="Contoh : 2020-07-08 10:45:00" required>
                                </div>
                                <div class="form-group mb-4">
                                            ...
                                            <table class="table table-bordered mb-4">
                                                ...
                                                <tbody id="itemlist">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select id="opsi2" name="data[1][supplier_id]" class="form-control selectpicker" data-live-search="true" required>
            ...
            <div class="row">
                <div id="form_grid_layouts" class="col-lg-12">
                    <div class="seperator-header">
                        <h4 class="">Formulir Permohonan Barang Masuk</h4>
                    </div>
                </div>
