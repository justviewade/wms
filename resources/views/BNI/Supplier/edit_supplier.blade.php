        ...
        <div class="container">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ubah Data Supplier - {{$data_sup->nama_supplier}}</li>
                </ol>
            </div>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Ubah Data Supplier - {{$data_sup->nama_supplier}}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="update" action="{{ url('updatesupplier')}}" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input name="nama_supplier" class="form-control" value="{{$data_sup->nama_supplier}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Alamat Supplier</label>
                                    <textarea name="alamat_supplier" class="form-control"  rows="3">{{$data_sup->alamat_supplier}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Alamat Email</label>
                                    <input name="email_supplier" type="email" class="form-control" value="{{$data_sup->email_supplier}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label>Nomor Telp</label>
                                    <input name="telp_supplier" class="form-control" value="{{$data_sup->telp_supplier}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label style="font-style: italic;">Person In Charge (PIC)</label>
                                    <input name="PIC" type ="text" class="form-control" value="{{$data_sup->PIC}}">
                                </div>
            ...
            <div class="row">
                ...
                <div id="form_grid_layouts" class="col-lg-12">
                    <div class="seperator-header">
                        <h4 class="">Ubah Data Supplier</h4>
                    </div>
                </div>
