        ...
        <div class="container">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ubah Data Barang - {{$data_bar->nama_barang}}</li>
                </ol>
            </div>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Ubah Data Barang - {{$data_bar->nama_barang}}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="update" action="{{ url('updatebarang')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input name="nama_barang" class="form-control" value="{{$data_bar->nama_barang}}" required>
                                </div>
                                <div class="form-group mb-4">
                                <label>Kategori Barang</label><br>
                                <select name="kategori_id" class="selectpicker" data-live-search="true" required>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input name="SKU" class="form-control" value="{{$data_bar->SKU}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Harga Satuan(Rp)</label>
                                    <input name="harga" id="money" class="form-control" value="{{$data_bar->harga}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Tahun Pengadaan</label>
                                    <input name="tahun" id="date4" class="form-control" value="{{$data_bar->tahun}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Spesifikasi Barang</label>
                                    <textarea name="spesifikasi_barang" class="form-control"  rows="3">{{$data_bar->spesifikasi_barang}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    @endif
                                        ...
                                        <input type="checkbox" id="hapus_foto" name="hapus_foto" value="true">
                                        <label for="Hapus Foto">Tanpa Foto</label><br>
                                    </div>
                                    @error('foto_barang')
