        ...
        <div class="container">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ubah Data Pelanggan - {{$data_pel->nama_pelanggan}}</li>
                </ol>
            </div>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Ubah Data Pelanggan - {{$data_pel->nama_pelanggan}}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="update" action="{{ url('updatepelanggan')}}" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input name="nama_pelanggan" class="form-control" value="{{$data_pel->nama_pelanggan}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Alamat pelanggan</label>
                                    <textarea name="alamat_pelanggan" class="form-control"  rows="3">{{$data_pel->alamat_pelanggan}}</textarea>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Alamat Email</label>
                                    <input name="email_pelanggan" type ="email" class="form-control" value="{{$data_pel->email_pelanggan}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label>Nomor Telp</label>
                                    <input name="telp_pelanggan" class="form-control" value="{{$data_pel->telp_pelanggan}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label style="font-style: italic;">Person In Charge (PIC)</label>
                                    <input name="PIC" type ="text" class="form-control" value="{{$data_pel->PIC}}">
                                </div>
            ...
            <div class="row">
                ...
                <div id="form_grid_layouts" class="col-lg-12">
                    <div class="seperator-header">
                        <h4 class="">Ubah Data Pelanggan</h4>
                    </div>
                </div>
