        ...
        <div class="container">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{url('formpelanggan')}}">Formulir Akun</a></li>
                </ol>
            </div>
                ...
                <div class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ url('inputakun')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-4">
                                    <label>Nama Pengguna</label>
                                    <input name="nama_pengguna" class="form-control" placeholder="Contoh : Yudishtira" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Alamat Email (Untuk Login)</label>
                                    <input name="email_pengguna" type ="email" class="form-control" placeholder="Contoh : yudistira@gmail.com">
                                    @error('email')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    @foreach($data_pel as $tampil)
                                        <option value="{{$tampil->peran_id}}">{{$tampil->nama_peran}}</option>
                                    @endforeach
                                </select>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Pelanggan BNI</label><br>
                                    <select id="selector_pelanggan" name="pelanggan_id" class="selectpicker" data-live-search="true" disabled>
...
@section('scriptbuttom')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
                ...
                $('#selector_peran').children('option[value=""]').remove();
