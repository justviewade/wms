    ...
    <div class="container" style="max-width:100% !important;">
        <div class="container">
            ...
            <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></a></li>
                ...
                <li class="breadcrumb-item"><a href="{{url('listpbmsps2')}}">List Penerimaan</a></li>
                <li class="breadcrumb-item active"><a href="{{url('formpbmsps2')}}">Penerimaan Tujuan</a></li>
            </ol>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Penerimaan Tujan</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form  id="dynamic" action="{{ url('inputpbm')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-4">
                                    <label>Kode PBK : </label>
                                    <input name="kode_pbm" class="form-control" value="PBK 0000001" readonly>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <label>Kurir</label>
                                    <input name="pembuat" class="form-control" value="">
                                </div>
                                   <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <label>Foto STT / Scan STT (Wajib) :</label>
                                    <div>
                                        <input type="file" name="foto_barang">
                                        </p class="text-warning"> [Ektensi file : jpg, jpeg, png, gif, pdf dan ukuran maksimal 2 megabyte]</p>
                                    </div>
                                    @error('foto_barang')
                                ...
                                <a class="mt-4 mb-4 btn btn-primary" href="{{ url('listpbksps4')}}">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div id="form_grid_layouts" class="col-lg-12">
                    <div class="seperator-header">
                        <h4 class="">Permohonan Barang Keluar - Penerimaan Tujuan</h4>
                    </div>
                </div>
