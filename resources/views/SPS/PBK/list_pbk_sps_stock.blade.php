    ...
    <div class="layout-px-spacing">
        ...
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{url('listpbkstock')}}">List Check Stock</a></li>
            </ol>
        </div>
        <br>
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="widget-header">
                        <div class="row">
                            <span class="col-xl-6 col-md-6 col-sm-6 col-6">
                                <h5 style="color:grey;"><strong>Check Stock</strong></h5>
                            </span>                      
                        </div>
                    </div>
                    <div class="table-responsive mb-4 mt-4">
                        <table id="alter_pagination" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_list_stock_pbk as $tampil)
                                <tr>
