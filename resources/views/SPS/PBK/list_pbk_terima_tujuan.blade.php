    ...
    <div class="layout-px-spacing">
        ...
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{url('listpbmsps2')}}">Penerimaan Barang Retur</a></li>
            </ol>
        </div>
        <br>
                        ...
                        <table id="alter_pagination" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-warning">Menuggu Konfirmasi Penerimaan</span>
                                    </td>

                                    <td>
                                        <button onclick="window.location.href='{{url('formpbksps4')}}'" id="aksi" class="btn btn-primary btn-sm action" data-toggle="modal" data-target="#actionModal">Aksi</button>
                                    </td>
