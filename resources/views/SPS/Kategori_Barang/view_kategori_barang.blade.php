        ...
        <div class="container">
            ...
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Lihat Data Kategori Barang - {{$data_kat->nama_kategori}}</li>
                </ol>
            </div>
                        ...
                        <div class="widget-header">                                
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Lihat Data Kategori Barang - {{$data_kat->nama_kategori}}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <form id="update" action="{{ url('updatekategoribarang')}}" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input name="nama_kategori" class="form-control" value="{{$data_kat->nama_kategori}}" disabled>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Kode Kategori</label>
                                    <input id="kode" name="kode_sku" class="form-control" value="{{$data_kat->kode_sku}}" disabled>
                                </div>
                                <div class="form-group mb-4">
                                    <label>Pelanggan</label>
                                    <select name="pelanggan_id" class="form-control selectpicker" data-live-search="true" disabled>
                                ...
                                <a class="mt-4 mb-4 btn btn-primary" href="{{ url('listkategoribarang')}}">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div id="form_grid_layouts" class="col-lg-12">
                    <div class="seperator-header">
                        <h4 class="">Lihat Data Kategori Barang</h4>
                    </div>
                </div>
